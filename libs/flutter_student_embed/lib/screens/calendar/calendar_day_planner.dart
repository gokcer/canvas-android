...
class CalendarDayPlanner extends StatefulWidget {
  ...
  CalendarDayPlanner(this._day, this._channel);
      ...
      builder: (_, snapshot, __) {
        ...
        if (snapshot.hasError) {
          ...
          if (snapshot.data.isEmpty) {
            ...
            body = CalendarDayList(snapshot.data, widget._channel);
          }
        }
...
class CalendarDayList extends StatelessWidget {
  ...
  CalendarDayList(this._plannerItems, this._channel);
  ...
  Widget _dayTile(BuildContext context, PlannerItem plannerItem, int index) {
    return CalendarDayListTile(plannerItem, _channel);
  }
}
