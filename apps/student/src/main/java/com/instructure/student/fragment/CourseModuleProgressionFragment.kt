...
class CourseModuleProgressionFragment : ParentFragment(), Bookmarkable {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        prev_item.background = ColorKeeper.getColoredDrawable(requireActivity(), R.drawable.vd_back_arrow, canvasContext)
        next_item.background = ColorKeeper.getColoredDrawable(requireActivity(), R.drawable.vd_forward_arrow, canvasContext)
    }
