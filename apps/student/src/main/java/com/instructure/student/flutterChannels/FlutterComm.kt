...
object FlutterComm {
    ...
    private const val METHOD_RESET_ROUTE = "resetRoute"
    ...
    fun sendUpdatedTheme() {
        ...
        data["primaryColor"] = Integer.toHexString(ThemePrefs.brandColor)
    ...
    fun resetRoute() = channel.invokeMethod(METHOD_RESET_ROUTE, null)
}
