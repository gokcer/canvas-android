...
class AppManager : com.instructure.canvasapi2.AppManager(), AnalyticsEventHandling {
    ...
    private fun initFlutterEngine() {
        ...
        // Run the 'warm' entrypoint to pre-warm the FlutterEngine
//        val entryPoint = DartEntrypoint(FlutterMain.findAppBundlePath(), "warm")
//        val entryPoint = DartEntrypoint(FlutterMain.findAppBundlePath(), "main")
